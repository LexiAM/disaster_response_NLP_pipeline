...
def load_data(messages_filepath, categories_filepath):
    """ Load Disaster Response messages and categories data from csv files into pandas DataFrame for classification training.
...
def clean_data(df):
    ...
    # use first row of new categories frame to rename columns with category names
